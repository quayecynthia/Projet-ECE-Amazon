<?php
	...
	if($error){
	 	...
	 	$sql2 = "INSERT INTO acheteur(Nom, Prenom, Email, Mdp, Adresse1, Adresse2, Ville, Code_Postal, Pays, Tel, Type_carte, Num_carte, Expiration_carte, Nom_carte, Crypto)
	 			VALUES('$nom', '$prenom', '$email', '$mdp', '$adresse1', '$adresse2', '$ville', '$code_postale', '$pays', '$tel', '$type_carte', '$num_carte', '$expiration_carte', '$nom_carte', '$crypto')";
