<?php
    ...
    if($error){
        ...
        if (mysqli_num_rows($result) != 0) {
            echo "<h3> La commande a bien été validé. Un email de confirmation vous a été envoyé<h3>.";
            echo "<img src= 'pouce.png' alt='Image non trouvée' height='600' width ='600'/>";
            ...
            echo "La commande n'a pas été validé !";
        }
    }
